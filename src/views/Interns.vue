    ...
    <div>
        ...
        <div class="intern-view">
            <section class="create-section">
                ...
                <p>
                    Crie um login para a pessoa estagiária e as equipes
                    hipotéticas que ela escolheria.
                </p>
                <p>
                    Para atualizar as opções de equipes de um Dextragiário que
                    já existe, é só repetir o login dele no campo "Login"
                </p>
            ...
            <section class="list-section">
                <div>
                    ...
                    <p>
                        Nessa listagem você pode observar os Dextragiários
                        cadastrados e suas equipes escolhidas. Você também tem a
                        opção de removê-las.
                    </p>
